...
class AddressDialog {
    ...
    class Builder(context: Context) : BaseDialog.Builder<Builder>(context), OnTabListener,
        ...
        private val titleView: TextView? by lazyFindViewById(R.id.tv_address_title)
        private val closeView: ImageView? by lazyFindViewById(R.id.iv_address_close)
        private val tabView: RecyclerView? by lazyFindViewById(R.id.rv_address_tab)
        private val viewPager2: ViewPager2? by lazyFindViewById(R.id.vp_address_pager)

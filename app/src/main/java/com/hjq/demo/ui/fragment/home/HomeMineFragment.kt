 ...
 *    desc   : 我的 Fragment
 */
class HomeMineFragment : TitleBarFragment<HomeActivity>() {
    ...
    override fun initView() {
        setOnClickListener(R.id.btn_home_mine_dialog, R.id.btn_home_mine_hint, R.id.btn_home_mine_login, R.id.btn_home_mine_register,
            R.id.btn_home_mine_forget, R.id.btn_home_mine_reset, R.id.btn_home_mine_change, R.id.btn_home_mine_personal, R.id.btn_home_mine_setting,
            R.id.btn_home_mine_about, R.id.btn_home_mine_guide, R.id.btn_home_mine_browser, R.id.btn_home_mine_image_select, R.id.btn_home_mine_image_preview,

...
class TimeDialog {
    ...
    class Builder(context: Context) : StyleDialog.Builder<Builder>(context) {
        ...
        private val hourView: RecyclerView? by lazyFindViewById(R.id.rv_time_hour)
        private val minuteView: RecyclerView? by lazyFindViewById(R.id.rv_time_minute)
        private val secondView: RecyclerView? by lazyFindViewById(R.id.rv_time_second)

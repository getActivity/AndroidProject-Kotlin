...
class TipsDialog {
    ...
    companion object {
        var ICON_FINISH: Int = R.drawable.tips_finish_ic
        var ICON_ERROR: Int = R.drawable.tips_error_ic
        var ICON_WARNING: Int = R.drawable.tips_warning_ic
    }

    class Builder(context: Context) : BaseDialog.Builder<Builder>(context),
        Runnable, BaseDialog.OnShowListener {

        private val messageView: TextView? by lazyFindViewById(R.id.tv_tips_message)
        private val iconView: ImageView? by lazyFindViewById(R.id.iv_tips_icon)

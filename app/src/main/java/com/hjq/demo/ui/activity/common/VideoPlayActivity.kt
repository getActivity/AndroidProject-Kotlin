...
open class VideoPlayActivity : AppActivity(), OnPlayListener {
    ...
    private val playerView: PlayerView? by lazyFindViewById(R.id.pv_video_play_view)
    ...
    class Builder : Parcelable {
        ...
        fun start(context: Context) {
            val intent = context.createIntent()
            when (activityOrientation) {
                ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE -> intent.setClass(context, Landscape::class.java)
                ActivityInfo.SCREEN_ORIENTATION_PORTRAIT -> intent.setClass(context, Portrait::class.java)

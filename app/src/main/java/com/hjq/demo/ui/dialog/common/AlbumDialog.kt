...
class AlbumDialog {
    ...
    class AlbumAdapter(context: Context) : AppAdapter<AlbumInfo>(context) {
        ...
        inner class ViewHolder : AppViewHolder(R.layout.album_item) {
            ...
            private val iconView: ImageView? by lazyFindViewById(R.id.iv_album_icon)
            private val nameView: TextView? by lazyFindViewById(R.id.tv_album_name)
            private val remarkView: TextView? by lazyFindViewById(R.id.tv_album_remark)
            private val checkBox: CheckBox? by lazyFindViewById(R.id.rb_album_check)
